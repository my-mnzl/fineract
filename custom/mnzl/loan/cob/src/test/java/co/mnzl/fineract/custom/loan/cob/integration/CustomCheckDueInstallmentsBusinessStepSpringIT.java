 ...
 *
 * The module is active whenever it is present in the image, so this slice verifies primary selection and collaborator
 * injection without an enablement flag.
 */
