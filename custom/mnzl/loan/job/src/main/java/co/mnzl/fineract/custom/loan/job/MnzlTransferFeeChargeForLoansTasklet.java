...
public class MnzlTransferFeeChargeForLoansTasklet extends TransferFeeChargeForLoansTasklet {

    private static final Logger LOG = LoggerFactory.getLogger(MnzlTransferFeeChargeForLoansTasklet.class);
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        if (!errors.isEmpty()) {
            LOG.error("TransferFeeChargeForLoans job completed with {} errors out of {} total charges", errors.size(),
                    chargeDatas != null ? chargeDatas.size() : 0);
        ...
        try {
            transactionTemplate.execute(new TransactionCallbackWithoutResult() {
                ...
                protected void doInTransactionWithoutResult(@NonNull TransactionStatus status) {
                    ...
                    LOG.debug("Successfully transferred fee charge {} for loan id {}", accountTransferDTO.getChargeId(),
