...
public class MnzlBalloonLoanInstrument {

    public boolean supports(String instrumentCode) {
        return MnzlLoanProductStrategyCodes.INSTRUMENT_BALLOON_LOAN.equals(instrumentCode);
    }
}
