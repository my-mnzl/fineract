...
public class MnzlAmountInterestAndPenaltiesChargeCalculationValidator implements ChargeCalculationValidator {
    ...
    @Override
    public String validateLoanCharge(final LoanCharge loanCharge) {
    ...
    @Override
    public String validateLoanProductRestriction(final ChargeTimeType chargeTime, final LoanProduct loanProduct) {
    ...
    private boolean usesCustomChargeStrategy(final Long loanProductId) {
