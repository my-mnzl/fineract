...
public class PercentOfDisbursementAmountChargeAmountCalculator implements ChargeAmountCalculator {

    @Override
    public Integer calculationType() {
        return ChargeCalculationType.PERCENT_OF_DISBURSEMENT_AMOUNT.getValue();
    }
