...
class COBBusinessStepServicePrimarySelectionTest {
    ...
    void getCOBBusinessStepsPrefersPrimaryBeanForSameEnumStyledName() {
        ...
        when(applicationContext.getBean("defaultStep", TestBusinessStep.class)).thenReturn(defaultStep);
        when(applicationContext.getBean("primaryStep", TestBusinessStep.class)).thenReturn(primaryStep);
